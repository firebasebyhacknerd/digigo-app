...
export default function PrivacyPolicy() {
  return (
    <main className="mx-auto max-w-4xl space-y-4 px-4 py-12">
      ...
      <p className="text-white/70">We collect contact details to size and quote E-SOFT systems. Data is stored securely and not sold to third parties.</p>
      <ul className="list-disc space-y-2 pl-5 text-white/80 text-sm">
      ...
      <p className="text-sm text-white/70">For questions or deletion requests, email info.digigo@gmail.com.</p>
    </main>
  );
}
