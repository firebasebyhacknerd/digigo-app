...
export function PageHero({ title, subtitle, kicker, actions }: Props) {
  return (
    <section className="relative overflow-hidden border-b border-border bg-surface-2 py-16">
      ...
      <div className="absolute -left-40 -top-32 h-96 w-96 rounded-full bg-neon/12 blur-3xl" aria-hidden />
      <div className="absolute -right-40 -bottom-32 h-80 w-80 rounded-full bg-neon-bright/12 blur-3xl" aria-hidden />
      ...
      <div className="relative mx-auto flex max-w-7xl flex-col gap-6 px-4 md:flex-row md:items-center md:justify-between">
        ...
        {actions ?? (
          <div className="flex gap-3">
            ...
            <Button asChild variant="outline" className="border-neon/40 text-neon hover:bg-neon/10">
